...
public class NetworkUtils {
    ...
    private static final String BASE_URL =  "http://192.168.1.14:8000/public/api/";
    //private static final String BASE_URL =  "http://localhost:8000/api/bai-hat?page=1&limit=15"; // AVD
